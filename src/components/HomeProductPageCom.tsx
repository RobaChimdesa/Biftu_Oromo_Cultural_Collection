...
//       {/* PRODUCT GRID */}
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 mx-16">
...
//         <button className="group border-2 border-[#1f1f39] rounded-full px-5 md:px-8 py-2 text-xl md:text-2xl font-semibold text-[#1f1f39] hover:bg-orange-500 hover:border-orange-500 hover:text-white transition-all duration-300 cursor-pointer">
...
const HomeProductComp = () => {
  ...
  return (
    <section className="w-full bg-[#f5f5f5] py-24 px-4 md:px-16 mx-auto cursor-alias">
      ...
      <div className="flex items-center justify-center mt-16">
        <button className="group border-2 border-[#1f1f39] rounded-full px-5 md:px-8 py-2 text-xl md:text-xl font-semibold text-[#1f1f39] hover:bg-orange-500 hover:border-orange-500 hover:text-white transition-all duration-300 cursor-pointer">
          <span className="flex items-center gap-3 cursor-pointer">
